...
SHOW WARNINGS;
CREATE UNIQUE INDEX `id_taquilla-envio_UNIQUE` ON `taquilla_envio` (`id_taquilla_envio` ASC) VISIBLE;
...
LOCK TABLES `tipoUsuario` WRITE;
/*!40000 ALTER TABLE `tipoUsuario` DISABLE KEYS */;
INSERT INTO `lockerit`.`tamanio` (`id_tamanio`, `nombre_tamaño`, `alto`, `ancho`, `profundidad`) VALUES ('1', 'Pequeño', '10.922', '40.64', '63.5'), ('2', 'Mediano', '24.13', '40.64', '63.5'), ('3', 'Grande', '50.8', '40.64', '63.5');
/*!40000 ALTER TABLE `tipoUsuario` ENABLE KEYS */;
UNLOCK TABLES;
